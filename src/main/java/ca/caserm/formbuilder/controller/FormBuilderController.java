...
public class FormBuilderController {
     ...
     */
    @PostMapping("customs")
    public ResponseEntity<ResponseWrapper<FormDto>> saveForm(@RequestBody FormDto formDto) {
        ResponseWrapper<FormDto> responseWrapper = new ResponseWrapper<>();
    ...
    public ResponseEntity<ResponseWrapper<FormDto>> updateForm(@PathVariable Long id, @RequestBody FormDto formDto) {
        ResponseWrapper<FormDto> responseWrapper = new ResponseWrapper<>();
    ...
    public ResponseEntity<ResponseWrapper<FormTemplateDto>> saveFormTemplate(@RequestBody FormTemplateDto formTemplateDto) {
        ResponseWrapper<FormTemplateDto> responseWrapper = new ResponseWrapper<>();
    ...
    public ResponseEntity<ResponseWrapper<FormTemplateDto>> updateFormTemplate(@PathVariable Long id, @RequestBody FormTemplateDto formTemplateDto) {
        ResponseWrapper<FormTemplateDto> responseWrapper = new ResponseWrapper<>();
