...
class FormTemplateRepositoryTests extends AbstractRepositoryTests {
    ...
    void testFindAllFormTemplateDataViews() throws IOException {
        FormTemplate formTemplate = saveTestEntity(getObjectFromJson("json/form_template.json", FormTemplate.class));
    ...
    void testFindAllFormTemplateViews() throws IOException {
        ...
        saveTestEntity(getObjectFromJson("json/form_template.json", FormTemplate.class));
