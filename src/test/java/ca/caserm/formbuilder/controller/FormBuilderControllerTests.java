...
class FormBuilderControllerTests extends AbstractTests {
    ...
    void testGetAllForms() throws Exception {
        ...
        verify(mockFormBuilderService, times(1)).getAllForms();
    }
    ...
    void testGetAllFormsByAccountId() throws Exception {
        ...
        mockMvc.perform(get("/forms/customs/by/accountId/" + ID)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.responseEntity.*", hasSize(2)))
        ...
        verify(mockFormBuilderService, times(1)).getAllFormsByAccountId(anyLong());
    }
    ...
    void testGetAllFormViewsByAccountId() throws Exception {
        ...
        mockMvc.perform(get("/forms/customs/views/by/accountId/" + ID)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
        ...
        verify(mockFormBuilderService, times(1)).getAllFormViewsByAccountId(anyLong());
    }
    ...
    void testGetFormById() throws Exception {
        ...
        mockMvc.perform(get("/forms/customs/" + formDto.getId())
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.responseEntity.id", is(formDto.getId())));

        verify(mockFormBuilderService, times(1)).getFormById(anyLong());
    }
    ...
    void testGetFormById_NotFound() throws Exception {
        ...
        mockMvc.perform(get("/forms/customs/" + ID)
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    void testSaveForm() throws Exception {
        ...
        verify(mockFormBuilderService, times(1)).saveForm(any(FormDto.class));
    }
    ...
    void testUpdateForm() throws Exception {
        ...
        mockMvc.perform(put("/forms/customs/" + formDto.getId())
                        .with(csrf())
                        .content(asJsonString(formDto))
                        .contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
        ...
        verify(mockFormBuilderService, times(1)).existsFormById(anyLong());
        verify(mockFormBuilderService, times(1)).updateForm(any(FormDto.class));
    }
    ...
    void testUpdateForm_BadRequest() throws Exception {
        ...
        mockMvc.perform(put("/forms/customs/" + ID)
                        .with(csrf())
    ...
    void testDeleteForm() throws Exception {
        ...
        mockMvc.perform(delete("/forms/customs/" + ID)
                        .with(csrf())
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    void testGetAllFormTemplates() throws Exception {
        ...
        verify(mockFormBuilderService, times(1)).getAllFormTemplates();
    }
    ...
    void testGetAllFormTemplateDataViews() throws Exception {
        ...
        verify(mockFormBuilderService, times(1)).getAllFormTemplateDataViews();
    }
    ...
    void testGetAllFormTemplateViews() throws Exception {
        ...
        verify(mockFormBuilderService, times(1)).getAllFormTemplateViews();
    }
    ...
    void testGetFormTemplateById() throws Exception {
        ...
        mockMvc.perform(get("/forms/templates/" + formTemplateDto.getId())
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
        ...
        verify(mockFormBuilderService, times(1)).getFormTemplateById(anyLong());
    }
    ...
    void testGetFormTemplateById_NotFound() throws Exception {
        ...
        mockMvc.perform(get("/forms/templates/" + ID)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isNotFound());
    ...
    void testSaveFormTemplate() throws Exception {
        ...
        verify(mockFormBuilderService, times(1)).saveFormTemplate(any(FormTemplateDto.class));
    }
    ...
    void testUpdateFormTemplate() throws Exception {
        ...
        mockMvc.perform(put("/forms/templates/" + formTemplateDto.getId())
                        .with(csrf())
        ...
        verify(mockFormBuilderService, times(1)).existsFormTemplateById(anyLong());
        verify(mockFormBuilderService, times(1)).updateFormTemplate(any(FormTemplateDto.class));
    }
    ...
    void testUpdateFormTemplate_BadRequest() throws Exception {
        ...
        mockMvc.perform(put("/forms/templates/" + ID)
                        .with(csrf())
                        .content(asJsonString(formTemplateDto))
                        .contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isBadRequest())
    ...
    void testUpdateFormTemplateEnabled() throws Exception {
        ...
        mockMvc.perform(put("/forms/templates/enabled/" + ID)
                        .with(csrf())
                        .contentType(MediaType.APPLICATION_JSON)
        ...
        verify(mockFormBuilderService, times(1)).existsFormTemplateById(anyLong());
        verify(mockFormBuilderService, times(1)).updateFormTemplateEnabled(anyLong(), anyBoolean());
    }
    ...
    void testDeleteFormTemplate() throws Exception {
        ...
        mockMvc.perform(delete("/forms/templates/" + ID)
                        .with(csrf())
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isNoContent());

        verify(mockFormBuilderService, times(1)).existsFormTemplateById(anyLong());
        verify(mockFormBuilderService, times(1)).deleteFormTemplate(anyLong());
    }
