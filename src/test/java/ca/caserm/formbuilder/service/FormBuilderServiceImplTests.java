...
class FormBuilderServiceImplTests extends AbstractTests {
    ...
    void testGetAllForms() throws IOException {
        ...
        verify(mockFormRepository, times(1)).findAll();
    ...
    void testGetAllFormsByAccountId() throws IOException {
        ...
        verify(mockFormRepository, times(1)).findAllByAccountId(anyLong());
        verify(defaultConversionService, times(2)).convert(any(Form.class), eq(FormDto.class));
    }
    ...
    void testFindAllFormViewsByAccountId() throws IOException {
        ...
        verify(mockFormRepository, times(1)).findAllFormViewsByAccountId(anyLong());
    }
    ...
    void testGetFormById() throws IOException {
        ...
        verify(mockFormRepository, times(1)).findById(anyLong());
        verify(defaultConversionService, times(1)).convert(any(Form.class), eq(FormDto.class));
    }
    ...
    void testGetAllFormTemplates() throws IOException {
        ...
        verify(mockFormTemplateRepository, times(1)).findAll();
    ...
    void testGetAllFormTemplateDataViews() throws IOException {
        ...
        verify(mockFormTemplateRepository, times(1)).findAllFormTemplateDataViews();
    }
    ...
    void testGetAllFormTemplateViews() throws IOException {
        ...
        verify(mockFormTemplateRepository, times(1)).findAllFormTemplateViews();
    }
    ...
    void testGetFormTemplateById() throws IOException {
        ...
        verify(mockFormTemplateRepository, times(1)).findById(anyLong());
        verify(defaultConversionService, times(1)).convert(any(FormTemplate.class), eq(FormTemplateDto.class));
    }
